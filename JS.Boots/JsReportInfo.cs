...
namespace JS.Boots
{
    ...
    public class JsReportInfo
    {
        ...
        /// <returns></returns>
        public static PdfMakeResult MakeReport(JsReportInfo reportInfo)
        {
            ...
            string pdfFolderPathTemp = ReportPdfFilePathTemp + "AC003029/" + yyyyMM + "/";
            string pdfFolderPath = AttachFile.AttachFilePath + "AC003029/" + yyyyMM + "/";
            ...
            // 파일명 : 년월일-시분초-랜덤.확장자
            // 예 : 20130222-18214632-75068418.pdf
            ...
            try
            {
                ...
                //CSV 설정
                var csvContent =
                    (CsvContent)ContentFactory.createContent(com.clipsoft.rextoolkit.oof.enumtype.ContentType.CSV);
                ...
                pdfExportParameter.setFileName(reportInfo.PdfFileName/*"sample22.pdf"*/);
                ...
                using (var fileStream = System.IO.File.Create(pdfFolderPath + reportInfo.PdfFileName))
                {
                ...
                pdfMakeResult.makePdfFileFullPath = pdfFolderPath + reportInfo.PdfFileName;
                pdfMakeResult.makePdfFilePath = "/" + yyyyMM + "/" + reportInfo.PdfFileName;
                pdfMakeResult.makePdfFileName = reportInfo.PdfFileName;
            }
            catch (Exception ex)
            {
                throw;
